...
function animateRandomSubtitle() {
  const subtitles = [
    ...
    "Finding 0days in my sleep (and dreams).",
    "root@arsh:~# blog && chill",
    "My recon phase lasts longer than my attention span.",
    "Popping shells, not pills.",
    "Bruteforcing my way through life.",
    "This blog is brought to you by a race condition.",
    "My only constant is CVEs.",
    "Exploiting bugs and personal flaws alike.",
    "My threat model includes Mondays.",
    "This was a 50-point challenge. My sanity was not included.",
    "Still stuck on the warmup challenge.",
    "CTFs: Where sleep is optional and sudo is everything.",
    "Owned the box. Still can’t own my schedule.",
    "I don’t always solve, but when I do, it’s accidental.",
    "My favorite flags are the ones I didn’t guess.",
    "Payload or placebo?",
    "Hack the planet... or at least the scoreboard.",
    "Ret2fun and back again.",
    "My CTF writeups have more typos than exploits.",
    "CAN you feel the packets tonight?",
    "This car talks. I just listen... and fuzz.",
    "Your ECU has a story. I have Wireshark.",
    "My idea of tuning a car involves a debugger.",
    "Hacking cars legally — don’t @ me.",
    "CAN bus or can't bus?",
    "Reverse engineering my way through traffic.",
    "OBD-II more like OMG-HACK.",
    "The only traction control I have is caffeine.",
    "It’s not car theft if it’s on a bench setup.",
    "If this blog breaks, it's a feature.",
    "Documenting my mistakes so you don’t have to repeat them.",
    "All errors are logged. Some emotionally.",
    "This is what overthinking looks like in Markdown.",
    "Built with Hugo. Fixed with stubbornness.",
    "Just Arsh things™.",
    "This post was sponsored by procrastination.",
    "Trying, failing, blogging anyway.",
    "Coffee. Code. Cry. Repeat.",
    "I break things so you can learn from the damage.",
    "This subtitle changes every time. Like my career path.",
    "You refreshed. I refreshed. Let’s move on.",
    "404: Subtitle consistency not found.",
    "Reading this won’t make you a hacker. But it helps.",
    "Cybersecurity: because computers weren’t scary enough.",
    "I hack, therefore I am... tired.",
    "Ever feel like you're just a process in someone else's thread?",
    "Now typing: one blog post and 100 regrets.",
    "The blog nobody asked for, but here we are.",
    "You're not supposed to read this far.",
    "If this brain dump breaks, it's a feature.",
    "Hacking vehicles legally — don’t @ me.",
    "You refreshed. I refreshed. Let’s move on..",
    "Hacking vehicles legally — don’t @ me. (probably)",
    "CAN bus or can't bus?.",
    "You refreshed. I refreshed. Let’s move on..",
    "I hack, therefore I am... tired. (probably)",
    "Owned the box. Still can’t own my schedule..",
    "Hacking vehicles legally — don’t @ me. (probably).",
    "My only constant is CVEs. (probably)",
    "You refreshed. I refreshed. Let’s move on. (probably)",
    "This is what overthinking looks like in Markdown..",
    "This is what overthinking looks like in Markdown. // TODO: clean this up",
    "Payload or placebo..?",
    "Exploiting bugs and personal flaws alike. (probably)",
    "CAN you feel the packets tonight?.",
    "Coffee. Code. Cry. Repeat..",
    "Just Arsh things™. (probably)",
    "CTFs: Where sleep is optional and sudo is everything. // TODO: clean this up",
    "Escaping the sandbox one shell at a time. (probably)",
    "All errors are logged. Some emotionally. (probably)",
    "Still stuck on the warmup challenge. // TODO: clean this up",
    "Ret2fun and back again..",
    "Built with Hugo. Fixed with stubbornness. (probably)",
    "This was a 50-point challenge. My sanity was not included. (probably)",
    "Your ECU has a story. I have Wireshark. (probably)",
    "I don’t always solve, but when I do, it’s accidental. (probably)",
    "This post was sponsored by procrastination. // TODO: clean this up",
    "CTFs: Where sleep is optional and sudo is everything..",
    "From CAN fuzzing to emotional debugging.",
    "Root access is a mindset.",
    "Flag-hunting my way through life.",
    "Just a guy reverse engineering life (and ECUs).",
    "Finding 0days in code and in my confidence.",
    "This is what happens when sleep is optional.",
    "Shells, sockets, and self-doubt.",
    "Red team dreams and black hoodie nights.",
    "There's a packet for that.",
    "Mistyped `rm -rf /` but somehow still here.",
    "My favorite IDE is cat and regret.",
    "All your logs are belong to us.",
    "Error 403: Motivation forbidden.",
    "Privilege escalated. Confidence not found.",
    "Auto-commit: chaos.",
    "More bugs than a summer hike.",
    "Ethical hacking: because jail isn't fun.",
    "Yes, I hack legally. No, I won’t fix your printer.",
    "Blogging so I don’t forget what I just learned.",
    "This title self-destructs on refresh.",
    "Under construction, like my mindset.",
    "Hack responsibly or get pwned trying.",
    "This is where I write so I don't forget.",
    "Somewhere between hobby and obsession.",
    "Legally weaponized keyboard.",
    "One packet away from a breakthrough.",
    "The only firewall I can’t bypass is writer’s block.",
    "Who needs sleep when there's a segfault?",
    "Learning, failing, and trying again — loudly.",
    "Reverse engineering everything — including myself.",
    "Pentesting cars, pentesting life.",
    "I don't hack for fun. I hack because curiosity is loud.",
    "Zero-day mindset, every day.",
    "Where exploits meet existentialism.",
    "Pwned once, learned forever.",
    "Step 1: Break it. Step 2: Understand it.",
    "CVE: Curiosity vs. Everything.",
    "Exploit the box, patch the ego.",
    "Ctrl+C my comfort zone.",
    ...
    "Tinkering with purpose (and some chaos).",
    "Wireshark > Stargazing.",
    "Injecting payloads, not malware.",
    "My IDE is a terminal and a dream.",
    "CAPTCHA is my mortal enemy.",
    "From reverse shell to real growth.",
    "Here lies another failed fuzzing attempt.",
    "This blog = stack trace of my brain.",
    "Burp Suite is my default browser.",
    "If found, return to /dev/null.",
    "Certified in breaking things that were working.",
    "I do it for the root shell. And the vibes.",
    "Cybersecurity isn't a job. It's an identity crisis.",
    "Where hex dumps meet heart dumps.",
    "Digital locksmith. Ethical lockpicker.",
    "Red team poet in a world of logs.",
    "Can’t stop, won’t patch.",
    "Security researcher by title. Chaos monkey by instinct.",
    "There’s no patch for curiosity.",
    "Just another node on the network.",
    "Building exploits, not expectations.",
    "System.out.println(“Send help”);",
    "May contain buffer overflows and deep thoughts.",
    "Getting flagged for curiosity since forever.",
    "Writing code. Breaking trust. Gaining insight.",
